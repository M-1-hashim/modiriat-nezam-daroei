...
import { cancelReturn, type ReturnKind } from "../../../_service";
...
// POST /api/returns/[type]/[id]/cancel — لغو برگشتی (فقط REQUESTED)
export async function POST(
  ...
  try {
    ...
    const result = await cancelReturn(user, parseKind(type), id, getClientIp(req));
    return ok(result);
  } catch (e) {
